...
export default function Cart() {
    ...
    const { cart, addProductToCart, priceToFloat,floatToPrice, calculateTotalPrice, totalPrice, decreaseProductQuantity } = useContext(CartContext);
