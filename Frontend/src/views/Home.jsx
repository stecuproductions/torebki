        ...
        <>
           ...
           <section>
            <div className='s3'>
                ...
                <img  loading="lazy" className='s3-i1' src="/images/s3-i1.webp" alt="Dwie osoby w jeansowych stylizacjach siedzące na białej skrzyni, prezentujące torby denimowe"  data-aos="fade-right"/>
                <img loading="lazy" className='s3-i2' src="/images/s3-i2.webp"  alt="Kobieta w białej koszulce i ciemnych spodniach z dużą, czarną torbą denimową na ramieniu"  data-aos="fade-left"/>
